...
public class SureOderMenuActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setData() {
        if (mSuperMarkeDetailEntity != null) {
            ...
            Glide.with(SureOderMenuActivity.this).load(mSuperMarkeDetailEntity.getPSimg()).asBitmap().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.square_seize).error(R.drawable.square_seize).into(new SimpleTarget<Bitmap>() {
                @Override
