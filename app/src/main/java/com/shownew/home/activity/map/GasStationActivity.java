...
public class GasStationActivity extends BaseLocationActivity implements AMap.OnInfoWindowClickListener, AMap.InfoWindowAdapter, View.OnClickListener, AMap.OnMarkerClickListener, PoiSearch.OnPoiSearchListener {
    ...
    protected void getLocation(AMapLocation location) {
        ...
        if (mMapView != null) {
            if (null != location && !isFirst) {
                ...
                doSearchQuery("加油站", new LatLonPoint(location.getLatitude(), location.getLongitude()), 5000, this);
//                mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(location.getLatitude(), location.getLongitude()), 12));
        ...
        infoView.findViewById(R.id.infowindows_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (null != location && marker != null) {
                    ...
                    //
                    //                    bundle.putParcelable("startLocaltion", mEndLatlng);
                    //                    bundle.putParcelable("endLocaltion", mStartLatlng);
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                ...
                if (poiItems != null && poiItems.size() > 0) {
                    ...
                    for (PoiItem poiItem : poiItems) {
                        startGrowAnimation(addMarkersToMap(mAMap, R.drawable.gasstationlocation, new LatLng(poiItem.getLatLonPoint().getLatitude(), poiItem.getLatLonPoint().getLongitude()), true, poiItem.getTitle(), ""));
                    }
