 ...
 * 停车场
 */
public class StopCarActivity extends BaseLocationActivity implements AMap.OnInfoWindowClickListener, AMap.InfoWindowAdapter, View.OnClickListener, AMap.OnMarkerClickListener, PoiSearch.OnPoiSearchListener {
    ...
    protected void getLocation(AMapLocation location) {
        ...
        if (mMapView != null) {
            if (null != location && !isFirst) {
                ...
                doSearchQuery("停车场", new LatLonPoint(location.getLatitude(), location.getLongitude()), 5000, this);
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                ...
                if (poiItems != null && poiItems.size() > 0) {
                    ...
                    for (PoiItem poiItem : poiItems) {
                        startGrowAnimation(addMarkersToMap(mAMap, R.drawable.parkinglocation, new LatLng(poiItem.getLatLonPoint().getLatitude(), poiItem.getLatLonPoint().getLongitude()), true, poiItem.getTitle(), ""));
                    }
