...
public class PasswordView extends RelativeLayout {
    ...
    public TextView getMoneyCharge() {
        return mMoneyCharge;
    }

    public TextView getMoney_tips() {
        return mMoney_tips;
    }

    private void initView(View view) {
        mMoneyCharge = (TextView) view.findViewById(R.id.textAmount);
        mMoney_tips = (TextView) view.findViewById(R.id.money_tips);
