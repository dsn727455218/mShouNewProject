package com.wp.baselib.utils.imagepicker.view;
...
public class CropImageView extends ImageView {
    ...
    private int mFocusWidth = 250;         //焦点框的宽度250
    ...
    public Bitmap getCropBitmap(int expectWidth, int exceptHeight, boolean isSaveRectangle) {
        ...
        if (null == srcBitmap) {
            ToastUtil.showToast("该图片不存在,请选择其他图片");
            return srcBitmap;
        }
    ...
    private File createFile(File folder, String prefix, String suffix) {
        ...
        String filename = "wp_image_cache" + suffix;
