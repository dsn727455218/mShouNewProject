...
import com.wp.baselib.utils.ScreenUtils;
...
public class WheelView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        if (curPosition == position) { // 选中
            setTextView(itemView, textView, textColorFocus, 18, 1.0f);
        } else { // 未选中
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = ScreenUtils.dip2px(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = ScreenUtils.dip2px(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);

            int height = ScreenUtils.dip2px(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = ScreenUtils.dip2px(context, ITEM_MARGIN);
